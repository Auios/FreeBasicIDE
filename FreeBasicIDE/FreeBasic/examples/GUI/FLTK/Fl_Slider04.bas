...
'test of:
' Fl_Value_Slider() http://www.fltk.org/doc-1.3/classFl__Slider.html
...
sub TimeoutHandler cdecl (byval userdata as any ptr)
  static as double ow=0.0
...
for i as integer = 0 to MAX_SLIDERS-1
  sliders(i) = Fl_Value_SliderNew(10+i*30, 10, 30,150)
  Fl_WidgetSetSelectionColor sliders(i),Fl_RGB_color(0,128,128)
