...
sub InputCB cdecl (byval self as Fl_Widget ptr,byval iam as any ptr)
  print "InputCB: " & *Fl_Input_GetValue(iam)
end sub

function Fl_InputGridNew(byval parent     as Fl_Group ptr, _
