...
'/
 ...
 ' ##########
  ...
  #ifndef __FB_64BIT__
   #libpath "lib/win32"
   #inclib "fltk-c-1.3.3-static-32" ' Windows 32-bit
  #else
   #libpath "lib/win64"
   #inclib "fltk-c-1.3.3-static-64" ' Windows 64-bit
  #endif
  ...
  #inclib "comctl32"
   ...
   #libpath "lib/lin32"
   #ifndef syslib
    #inclib "fltk-c-1.3.3-static-32"
   #else
    #inclib "fltk-c-1.3.3-static-32-syslib" 
   #endif
  
  #else
   #libpath "lib/lin64"
   #ifndef syslib
    #inclib "fltk-c-1.3.3-static-64"
   #else
    #inclib "fltk-c-1.3.3-static-64-syslib" 
   #endif
  #endif
  ...
  #inclib "fltk_gl"
  #inclib "fltk_images"
  #ifndef syslib ' we use FLTK lib's libfltk_jpeg.a,libfltk_png.a,libfltk_zlib.a
   #inclib "fltk_jpeg"
   #inclib "fltk_png"
   #inclib "fltk_zlib"
  #else          ' we use libjpeg.a,libpng.a,libz.a from your distro
   #inclib "png"
   #inclib "jpeg"
   #inclib "z"
  #endif
...
declare function Fl_PreferencesNewChildGroup alias "Fl_PreferencesNewGroup2" (byval parent as Fl_Preferences ptr,byval groupIndex as long) as Fl_Preferences ptr
...
'#########################
declare function Fl_File_ChooserNew(byval pathname as const zstring ptr,byval pattern as const zstring ptr,byval typ as FL_FILECHOOSER_TYPE,byval title as const zstring ptr) as Fl_File_Chooser ptr
...
' Gets/Sets/Copy the current tooltip text.
...
declare function Fl_Tree_Item_ArrayGetConstItem alias "Fl_Tree_Item_ArrayGetItem2" (byval tia as Fl_Tree_Item_Array ptr,byval index as long) as const Fl_Tree_Item ptr
