...
Dim silhouette As Single = 0.2f

Dim as nShader shad = nLoadShader("media/shaders/ToonShading.vert","media/shaders/ToonShading.frag",0)
nSetPixelShaderConstant(shad,"silhouetteThreshold",@silhouette,1)

nApplyShadersEntity(shad,goku)
