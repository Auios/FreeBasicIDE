...
nSetLightColor(light01,200,30,50)
nSetEntityParent(bill01,light01)
nSetEntityPosition(light01,-50,175,100)
nSetLightCastShadow(light01)

light02=nCreateLight(LGT_SPOT)
nSetLightConeAngles(light02,15,30)
nSetLightColor(light02,50,200,50)
nSetEntityParent(bill02,light02)
nSetEntityPosition(light02,50,175,150)


nSetMeshCastShadow(ninja)


Dim as nShader shad = nLoadShader("media/shaders/Lighting.vert","media/shaders/OneSidedLighting.frag",0)

nApplyShadersEntity(shad,ninja)
nApplyShadersEntity(shad,mesh01)
nApplyShadersEntity(shad,mesh02)
nApplyShadersEntity(shad,mesh03)
nApplyShadersEntity(shad,mesh04)
nApplyShadersEntity(shad,mesh05)
...
While(EngineRun)'Returns 1 if the engine is running.
    ...
    nSetEntityLocalRotation(light02,2,0,0)
    
    nGetScreenCoordinatesFrom3DPosition(sx,sy,nGetEntityX(bill01),nGetEntityY(bill01),nGetEntityZ(bill01))
    nDrawFontText(sx+20,sy-20,"light01")
    nGetScreenCoordinatesFrom3DPosition(sx,sy,nGetEntityX(bill02),nGetEntityY(bill02),nGetEntityZ(bill02))
    nDrawFontText(sx+20,sy-20,"light02")
